...

{
  ...
  "description": "The conversion of PM is recorded when the Conversion Tag is placed on the Thank You page or when the event occurs.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  ...
  },
  {
    "type": "TEXT",
    "name": "clickId",
    "displayName": "Permate Click UUID",
    "simpleValueType": true
  },
  {
    "type": "TEXT",
...
// Setting sale value into PERMATE object before this Conversion Tag is fired
var PERMATE = existingPermateObject || {};
PERMATE.Conversion = PERMATE.Conversion || {};
PERMATE.Conversion.Sale = {};
PERMATE.Conversion.Sale.offerId = enc(data.offerId);
PERMATE.Conversion.Sale.eventId = enc(data.eventId);
if (data.saleValue != null) {
  PERMATE.Conversion.Sale.saleValue = enc(data.saleValue);
}
PERMATE.Conversion.Sale.isVND = enc(data.isVND);
PERMATE.Conversion.Sale.version = "gtmC_" + version;
if (data.clickId != null) {
...
const nsUrl = buildNs();
appendPixel(nsUrl,data.gtmOnSuccess(),data.gtmOnFailure());
...
- name: Untitled test 1
  code: |-
    const mockData = {
      // Mocked field values
      offerId: 16,       // Put your Permate Offer ID here
      eventId: 28,       // Put your Permate Event ID here
      saleValue: 30000,  // Put your Sale Value here
      isVND: true,
      clickId: "is_test_85129968dc6c430082fdab664047fb", // Put your Permate Click ID Test here
    };
...
Created on 11/19/2024, 1:49:17 PM